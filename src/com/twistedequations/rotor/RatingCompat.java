...
public final class RatingCompat implements Parcelable {
    ...
    /**
     * Converts the compat rating to the correct rating for the metadata
     * @return a populated android.media.Rating object
     */
    ...
    public android.media.Rating getRating() {
        ...
        switch (mRatingStyle) {
            ...
            case RATING_4_STARS:
            case RATING_5_STARS:
                rating = android.media.Rating.newStarRating(mRatingStyle, mRatingValue);
                break;

            case RATING_HEART:
                rating = android.media.Rating.newHeartRating(hasHeart());
                break;

            case RATING_PERCENTAGE:
                rating = android.media.Rating.newPercentageRating(mRatingValue);
                break;

            case RATING_THUMB_UP_DOWN:
                rating = android.media.Rating.newThumbRating(isThumbUp());
                break;

            default:
                if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    rating = android.media.Rating.newUnratedRating(RATING_PERCENTAGE);
                }
        }
        return rating;
    }
    ...
    public boolean equals(Object o) {
        return o != null && o instanceof RatingCompat && hashCode() == ((RatingCompat) o).hashCode();
    }

    @Override
    public int hashCode() {
        return (int) (17 * mRatingStyle + 31 * mRatingValue);
    }
}